...
public class MedianOfTwoArray {
	...
	public static int medianViaDevideAndConqure(int arr1[], int arr2[], int n) {
		...
		if (m1 < m2) {
			if (n % 2 == 0) {
				return medianViaDevideAndConqure(arr1 = Arrays.copyOfRange(arr1, n / 2 - 1, n - 1), arr2,
						n - n / 2 + 1);
			} else {
			...
			if (n % 2 == 0) {
				return medianViaDevideAndConqure(arr2 = Arrays.copyOfRange(arr2, n / 2 - 1, n - 1), arr1,
						n - n / 2 + 1);
			} else {
